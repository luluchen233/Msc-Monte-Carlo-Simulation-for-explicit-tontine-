...
runtime = 1
gamma_range = [-999,-3,-1,0,0.6, 0.7, 0.8, 0.9]
np.random.seed(30)
#假设进来的人最多只能活200年
num_of_people = 20
...
for i in range(len(gamma_range)):
    ...
    for run in range(runtime):
        ...
        ax.plot(list(range(50, 50+len(wealth))), wealth,label='$\gamma$='+str(gamma))
...
plt.title('The life long wealth for closed tontine ($\gamma$)')
plt.tight_layout()
